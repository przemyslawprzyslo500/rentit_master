...
@NamedQueries({
    ...
    , @NamedQuery(name = "Reserv.findByEmployee", query = "SELECT r FROM Reserv r WHERE r.accountId = :account AND r.reservStatusId.id = :reservStatusId")
    , @NamedQuery(name = "Reserv.findByEmployeeAccepted", query = "SELECT r FROM Reserv r WHERE r.accountId = :account AND (r.reservStatusId.id = :reservStatusId OR r.reservStatusId.id = :reservStatusId2)")
    , @NamedQuery(name = "Reserv.findReservationsEnd", query = "SELECT r FROM Reserv r WHERE r.reservStatusId.id = :reservStatusId")
    , @NamedQuery(name = "Reserv.findManagerEmployee", query = "SELECT r FROM Reserv r WHERE r.reservStatusId.id = :reservStatusId")
